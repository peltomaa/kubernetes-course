...
docker tag toukop/crud-backend:latest europe-north1-docker.pkg.dev/nomadic-charge-446815-j2/kubernetes-course/crud-backend:latest
docker tag toukop/crud-backend-worker:latest europe-north1-docker.pkg.dev/nomadic-charge-446815-j2/kubernetes-course/crud-backend-worker:latest
